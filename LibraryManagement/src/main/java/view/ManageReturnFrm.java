...
public class ManageReturnFrm extends javax.swing.JFrame {
    ...
    private List<BorrowReturn1> listborrow;
    private List<BorrowReturn1> listreturn;
    private int selectIndexBorrow;
    public ManageReturnFrm(User1 user) {
        initComponents();
    ...
    private void buttonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchActionPerformed
        ...
        if(keyString.isEmpty()){
            ...
            try {
                User1 r = new UserDAO().getUserByUserId(keyString);
                if(r == null){
    ...
    private void buttonReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonReturnActionPerformed
        ...
        if(selectIndexBorrow == -1){
            ...
            BorrowReturn1 br = listborrow.get(selectIndexBorrow);
            Date currentDate = new Date(new java.util.Date().getTime());
            try {
                new BorrowReturnDAO().updateBorrowReturnDateReturn(currentDate, br.getId());
                BorrowReturn1 br2 = new BorrowReturnDAO().getBorrowReturnById(br.getId());
                listreturn.add(br2);
                showTableReturn();
                showTableBorrow();
            } catch (SQLException ex) {
