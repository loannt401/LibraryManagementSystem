...
public class HomeFrm extends javax.swing.JFrame {
     ...
     */
    private User1 user;
    public HomeFrm(User1 user) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.user = user;
        textName.setText(user.getFullname());
        boolean check = false;
        for(Role1 r : user.getRole()){
            if(r.getId() == 2){
                check = true;
                break;
            }
    ...
    private void initComponents() {
        ...
        buttonCheckin.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        buttonCheckin.setForeground(new java.awt.Color(255, 255, 255));
        buttonCheckin.setText("Vào/Ra");
        buttonCheckin.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addComponent(buttonCheckin, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(buttonCheckin, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void buttonCheckinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCheckinActionPerformed
        // TODO add your handling code here:
        ManagerCheckinFrm frm = new ManagerCheckinFrm(user);
        this.setVisible(false);
        frm.setVisible(true);
