...
public class EditReaderFrm extends javax.swing.JDialog {
    ...
    ManageReaderFrm frm;
    public EditReaderFrm(java.awt.Frame parent, User1 r, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        date.setDate(new Date(r.getDate().getTime()));
        labelReaderid.setText(r.getUserid());
    }
