...
public class ReaderDetailFrm extends javax.swing.JFrame {
    ...
    List<BorrowReturn1> listBorrowReturn;
    public ReaderDetailFrm(User1 user, User1 reader) {
        initComponents();
        ...
        try {
            listBorrowReturn = new BorrowReturnDAO().getBorrowReturnByUserid(reader.getId());
            showTable();
...
//    }
    ...
    private void showTable() {
        model.setRowCount(0);
        int index = 1;
        for(BorrowReturn1 br : listBorrowReturn){
            int amount = 0;
            if(br.getErrorBookReturn().size() > 0){
