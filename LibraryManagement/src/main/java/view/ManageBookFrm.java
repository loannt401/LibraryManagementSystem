...
public class ManageBookFrm extends javax.swing.JFrame {
    ...
    public ManageBookFrm(User1 user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tableBook.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Tên sách", "Thể loại", "Giá tiền", "Số lượng", "Dãy", "Tầng"
            }
        ) {
        ...
        if (tableBook.getColumnModel().getColumnCount() > 0) {
            ...
            tableBook.getColumnModel().getColumn(2).setMaxWidth(150);
            ...
            tableBook.getColumnModel().getColumn(6).setMinWidth(80);
            tableBook.getColumnModel().getColumn(6).setMaxWidth(80);
        }
    ...
    private void buttonEditBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditBookActionPerformed
        ...
        if(selectIndexBook == -1){
            ...
            Book1 b = listbook.get(selectIndexBook);
        ...
        for(Book1 b : listbook){
            try {
                ...
                modelBook.addRow(new Object[]{
                    index++, b.getName(), b.getGenre().getName(), String.format("%,d", b.getPrice()) + " VND", quantity, b.getRow().getName(), b.getLevel().getName()
                });
            } catch (SQLException ex) {
                Logger.getLogger(ManageBookFrm.class.getName()).log(Level.SEVERE, null, ex);
            }
