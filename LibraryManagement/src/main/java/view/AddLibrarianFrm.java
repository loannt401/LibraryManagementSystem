...
public class AddLibrarianFrm extends javax.swing.JDialog {
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        ...
        if(nameString.isEmpty() || addressString.isEmpty() || textEmailString.isEmpty() ||
            ...
            if(new EmployeeDAO().getEmployeeByUsernameAndPassword(textUsernameString, textPassString) != null){
                ...
                u.setEmail(textEmailString);
                u.setPhone(textPhoneString);
                u.setAddress(addressString);
                Date currentDate = new Date();
                u.setDate(new java.sql.Date(currentDate.getTime()));
                u.setRole(listrole);
                Employee e = new Employee(u, textUsernameString, textPassString, true);
                try {
