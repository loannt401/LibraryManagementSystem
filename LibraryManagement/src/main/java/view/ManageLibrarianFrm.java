...
public class ManageLibrarianFrm extends javax.swing.JFrame {
    ...
    List<Employee> listlibrarian;
    public ManageLibrarianFrm(User1 user) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.user = user;
        model = (DefaultTableModel) table.getModel();
        try {
            listlibrarian = new EmployeeDAO().getAllEmployee();
            showTable();
    ...
    private void buttonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchActionPerformed
        ...
        if(keyString.isEmpty()){
            ...
            try {
                listlibrarian = new EmployeeDAO().getEmployeeByName(keyString);
                showTable();
            } catch (SQLException ex) {
                Logger.getLogger(ManageLibrarianFrm.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        ...
        if(selectIndex == -1){
            ...
            Employee u = listlibrarian.get(selectIndex);
...
//    }
    ...
    private void showTable() {
        model.setRowCount(0);
        int index = 1;
        for(Employee u : listlibrarian){
            String statusString = null;
            if(u.isStatus() == true) {
                statusString = "Đang làm";
            }
            else {
                statusString = "Đã nghỉ";
            }
            model.addRow(new Object[]{
                index++, u.getUserid(), u.getFullname(), u.getUsername(), statusString
            });
        }
    }
