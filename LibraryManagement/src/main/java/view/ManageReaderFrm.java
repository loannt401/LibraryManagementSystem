...
public class ManageReaderFrm extends javax.swing.JFrame {
    ...
    public ManageReaderFrm(User1 user) {
        initComponents();
    ...
    private void buttonViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonViewActionPerformed
        ...
        if(selectIndex == -1){
            ...
            User1 r = listreader.get(selectIndex);
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        if(selectIndex == -1){
            ...
            if (check == JOptionPane.YES_OPTION) {
                try {
                    new UserDAO().deleteUser(r.getId());
    ...
    private void buttonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchActionPerformed
        ...
        if(keyString.isEmpty()){
            ...
            try {
                listreader = new UserDAO().getUserByName(keyString, 3);
                showTable();
            } catch (SQLException ex) {
                Logger.getLogger(ManageReaderFrm.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        for(User1 r : listreader){
            try {
                ...
                model.addRow(new Object[]{
                    index++, r.getUserid(), r.getFullname(), r.getDate(), quantity
                });
            } catch (SQLException ex) {
                Logger.getLogger(ManageReaderFrm.class.getName()).log(Level.SEVERE, null, ex);
            }
