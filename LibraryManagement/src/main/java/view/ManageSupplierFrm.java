...
public class ManageSupplierFrm extends javax.swing.JFrame {
    ...
    public ManageSupplierFrm(User1 user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        buttonDelete.setBorder(javax.swing.BorderFactory.createEtchedBorder());
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        if(selectIndex == -1){
            ...
            Supplier s = listsupplier.get(selectIndex);
            int check = JOptionPane.showConfirmDialog(rootPane, "Bạn có chắc muốn xóa?");
            if (check == JOptionPane.YES_OPTION) {
                try {
                    new SupplierDAO().deleteSupplier(s.getId());
                    listsupplier = new SupplierDAO().getAllSupplier();
                    showTable();
                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(rootPane, "Không thể xóa nhà cung cấp!");
                }
            }
        }
